...
main:-
    ...
    %L es la lista de parejas de letras que no han de salir en el mismo dado; hacemos sort para no repetir parejas.
    ...
    % Y para romper simetrias, restricciones que ponemos imponer sin eliminar la solucion, y ser más eficientes:
